  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      ...
      <SettingsSection title={tSettings("section_support")}>
        ...
        />
        {/* Static help PDF (CGM sources). Generated by
            scripts/generate-cgm-matrix-pdf.mjs into public/help/.
            We pick the file by current UI locale so DE users get the
            German PDF and EN users the English one. Opened in a new
            tab so the user keeps their place in Settings. */}
        <SettingsRow
          iconColor={ACCENT}
          icon={ICON.support}
          ...
          onClick={() => window.open(
            uiLocale === "en" ? "/help/cgm-sources-en.pdf" : "/help/cgm-quellen-de.pdf",
            "_blank",
            "noopener,noreferrer",
          )}
        />
