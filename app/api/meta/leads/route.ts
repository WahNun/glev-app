...
//   5. provisioniert den User-Account,
//   6. ruft optional CRM_WEBHOOK_URL auf (kein Meta-Dependency).
//
// Webhook-URL: https://glev.app/api/meta/leads
//
// Erforderliche Vercel Environment Variables:
//   META_VERIFY_TOKEN          — frei wählbarer String, in Meta-App-Einstellungen hinterlegt
...
//   CRM_WEBHOOK_URL            — optional: eigene CRM/Slack/Mail-Relay-URL für neue Leads
...
async function processChange(value: any, pageId: string) {
  ...
  if (!PAGE_ACCESS_TOKEN)
    throw new Error("META_PAGE_ACCESS_TOKEN not set — cannot fetch lead data");
