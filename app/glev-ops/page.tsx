 ...
 *
 * Auth: same `glev_admin_token` cookie scoped to "/glev-ops" as every
...
export default async function AdminIndexPage({
  ...
  if (!authed) {
    ...
    return <AdminLoginForm action={loginAction} title="Glev — Admin" error={err} />;
  }
