...
//
// Cookie name and scope ("/glev-ops") match the per-page actions exactly,
...
export async function logoutAction(): Promise<void> {
  const store = await cookies();
  // Cookie was set with `path: "/glev-ops"`. Setting maxAge: 0 with the
