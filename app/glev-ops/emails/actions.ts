...
// Cookie mit `path: "/glev-ops"`, d. h. ein Login bei einem Tab gilt für
...
export async function logoutAction(): Promise<void> {
  const store = await cookies();
  // Cookie wurde mit `path: "/glev-ops"` gesetzt; das Löschen muss denselben
