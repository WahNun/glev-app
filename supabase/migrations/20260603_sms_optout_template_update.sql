...
UPDATE message_templates
SET
  sms_text   = E'Hast du Glev noch nicht ausprobiert? Als T1D-Nutzer:in hilft dir Glev dabei, deine Insulindosierung besser einzuschätzen. Dein kostenloser 7-Tage-Test: {{link}}\n\nAbmelden: https://glev.app/sms-stop?t={{token}}&u={{user_id}} · Fragen: lucas@glev.app',
  updated_at = now()
