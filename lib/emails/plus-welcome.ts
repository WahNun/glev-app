/**
 * HTML body for the post-Stripe-checkout welcome email for /pro (Glev+ SKU).
 *
 * Glev+ = €29/Monat ($29/month), Lifetime Lock — der Preis bleibt für immer
 * derselbe, egal wie sich die Standard-Pro-Preise ab Launch entwickeln.
 * Trial endet wie bei Pro am 1. Juli 2026, dann erste reguläre Abbuchung.
 *
 * Bewusst eine eigene Datei statt Conditional in pro-welcome.ts, weil die
 * Wertversprechen-Sätze unterschiedlich sind (Pro betont monatliche
 * Kündbarkeit, Plus betont Preisgarantie). Struktur mirror-t pro-welcome.ts
 * 1:1 damit visuelle Identität (Header, CTA, Footer) konsistent bleibt.
 *
...
export function plusWelcomeHtml(
  name?: string | null,
  ...
  if (locale === "en") return plusWelcomeHtmlEn(first, resumeUrl, trialEndsAt, unsubUrl);
  return plusWelcomeHtmlDe(first, resumeUrl, trialEndsAt, unsubUrl);
}

function plusWelcomeHtmlDe(
  first: string | null,
  resumeUrl: string,
  trialEndsAt?: string | null,
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#374151;">
                ${postGreetingOpener} Deine <strong>Glev+-Mitgliedschaft</strong>
                ist angelegt — und du kannst Glev ab sofort
                <strong>komplett kostenlos</strong> nutzen.
              </p>

              <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#374151;">
                Ab dem <strong>${trialEndDisplay}</strong> startet dann deine
                reguläre Mitgliedschaft für <strong>29&nbsp;€/Monat</strong>,
                automatisch über die hinterlegte Karte. Dein Preis ist
                <strong>für immer auf 29&nbsp;€ gelockt</strong> — auch wenn
                wir später für neue Pro-Käufer:innen die Preise anheben,
                bleibt deiner unverändert.
              </p>
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid #f1f5f9;">
              <p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;">
                Glev · <a href="mailto:hello@glev.app" style="color:#9ca3af;">hello@glev.app</a> · Diese E-Mail wurde an dich geschickt, weil du eine Glev+-Mitgliedschaft abgeschlossen hast.
              </p>
              ${unsubHtml}
            </td>
          </tr>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#374151;">
                ${postGreetingOpener} Your <strong>Glev+ membership</strong>
                is set up — and you can use Glev
                <strong>completely free</strong> starting right now.
              </p>

              <p style="margin:0 0 24px;font-size:15px;line-height:1.7;color:#374151;">
                On <strong>${trialEndDisplay}</strong> your regular membership
                kicks in at <strong>$29/month</strong>, billed automatically
                to the card on file. Your price is
                <strong>locked at $29 forever</strong> — even when we later
                raise prices for new Pro subscribers, yours stays the same.
              </p>
          ...
          <tr>
            <td style="padding:20px 40px;border-top:1px solid #f1f5f9;">
              <p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;">
                Glev · <a href="mailto:hello@glev.app" style="color:#9ca3af;">hello@glev.app</a> · You're receiving this email because you started a Glev+ membership.
              </p>
              ${unsubHtml}
            </td>
          </tr>
...
/**
 * Subject line for the Plus welcome email. Mirrors `proWelcomeSubject` —
 * personal first-name lead when available, generic fallback otherwise.
 */
