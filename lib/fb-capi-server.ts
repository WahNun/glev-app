...
const RELAY_BASE    = process.env.META_CAPI_RELAY_URL?.replace(/\/$/, "");
const GRAPH_BASE    = RELAY_BASE ?? "https://graph.facebook.com";
const GRAPH_URL     = `${GRAPH_BASE}/${API_VERSION}/${PIXEL_ID}/events`;
